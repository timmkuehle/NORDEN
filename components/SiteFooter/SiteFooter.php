		...
		<footer <?php $this->renderHTMLAttributes(); ?>>
			<div class="footer-content">
				<div class="slot start">
					...
					<a href="<?= BASE_URL ?>/kontakt" class="contact-link">Nach NORDEN</a>
					...
					<?php new \FooterMenu(null, 'footer-menu-mobile'); ?>
				</div>
				<div class="slot center">
					<h2 class="footer-heading uppercase">Let's work together</h2>
					<?php new \Button(null, 'hi-button', 'Say hi', 'mailto:mail@norden.co'); ?>
					<?php new \FooterMenu(null, 'footer-menu-desktop'); ?>
				</div>
				<div class="slot end">
      	...
      	'secondary'
						...
						<?php new \Button(null, null, 'Open Positions', '/jobs', 'secondary'); ?>
					</div>
				</div>
			</div>
		</footer>
