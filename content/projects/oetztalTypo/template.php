<section class="project-section full-width-new no-padding-top">
    ...
    <div class="content no-inline-padding-mobile">
        <?php new Video(
        	null,
        	'/content/resources/media/oetztalTypo/01_Header_Video.mp4',
        	'16/9',
    ...
    <div class="content" style="align-items: flex-start;">
        ...
        <div class="column" style="width: 42%;">
            <?php new Image(
            	null,
            	null,
            	'/content/resources/media/oetztalTypo/01_LeitideeBild.JPG',
            	'Ötztal Font Leitidee',
            	true
            ); ?>
        </div>
    </div>
...
<section class="project-section">
    ...
    <div class="content">
        <div class="column">
            <?php new Video(
            	null,
            	'/content/resources/media/oetztalTypo/OETZT_Umlaute_Anima.mp4',
            	'1/1',
            	'/content/resources/media/oetztalTypo/OETZT_Umlaute_Anima_Still.jpg',
            	'Ötztal Font',
            	true,
            	true,
            	true,
    ...
    <div class="content">
        <div class="column">
            <?php new Image(
            	null,
            	null,
            	'/content/resources/media/oetztalTypo/Modifizierung_A_1.svg',
            	'Ötztal Font Modifizierungen',
            	true
            ); ?>
            <?php new Image(
            	null,
            	'overlay',
            	'/content/resources/media/oetztalTypo/Modifizierung_A_2.svg',
            	null,
            	true
            ); ?>
        </div>
...
<section class="project-section full-width-new small-padding">
    ...
    <div class="content no-inline-padding-mobile">
        <?php new Video(
        	null,
        	'/content/resources/media/oetztalTypo/OETZT_Ligaturen.mp4',
        	'1920/700',
        	'/content/resources/media/oetztalTypo/OETZT_Ligaturen_Still.jpg',
        	'Ötztal Font Ligaturen',
        	true,
        	true,
        	true,
        	true,
...
<section id="typo-animation-section" class="project-section bg-col-dark-red" style="align-items: flex-end;">
    <div class="slot start">
        <p class="side-note">Typo Animation</p>
    </div>
    <div class="content">
        <?php new Video(
        	null,
        	'/content/resources/media/oetztalTypo/OETZT_Typo_Anima_Konzept.mp4',
        	'16/9',
        	'/content/resources/media/oetztalTypo/OETZT_Typo_Anima_Konzept_Still.jpg',
...
<section id="big-a-section" class="project-section full-width-new no-padding-top has-background-image">
    <div class="slot start"></div>
    <div class="content no-inline-padding-mobile" style="align-items: flex-start;">
        <?php new Image(
        	null,
        	null,
        	'/content/resources/media/oetztalTypo/06_OETZT_TypoA_groß.svg',
        	'Ötztal Font A',
        	true
        ); ?>
    </div>
    ...
    <?php new Image(
    	null,
    	'background-image',
    	'/content/resources/media/oetztalTypo/07_OETZT_Claim.svg',
    	'Ötztal bewegt dich',
    	true
    ); ?>
</section>
<section id="overview-section" class="project-section">
    <div class="slot start"></div>
    <div class="content" style="align-items: stretch;">
        <div class="column" style="width: 12%;">
            <p class="col-red">Customized Headline Font</p>
            <p class="col-red">Ötztal</p>
        </div>
        <div class="column" style="width: 88%;">
            <?php new Image(
            	null,
            	null,
            	'/content/resources/media/oetztalTypo/01_Header.svg',
            	'Ötztal Font Header',
            	true
            ); ?>
        </div>
